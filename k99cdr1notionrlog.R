...
k99 = subset(k99, k99$Group %in% c("Control", "CDR1"))
...
saveRDS(dds, "K99ddsADALLCDR1vsControls_sex_age_notion")

dds <- readRDS("K99ddsADALLCDR1vsControls_sex_age_notion")
...
saveRDS(clean.dds, "K99ddsADALLCDR1vsControlsqc_sex_age_notion") #
 ...
 # write.table (res, "k99cdr1notion.tsv", quote=FALSE, col.names=T, row.names=T, sep="\t")
# 
# outliers = res[1]
...
saveRDS(rld, "rldK99ddsADALLCDR1vsControls_sex_age_notion")
...
saveRDS(data.pheno, file = "matrix_rldK99ddsADALLCDR1vsControls_sex_age_notion")


# Porque entran genes con 0 valores



# rld = readRDS("rldK99ddsADALLCDR1vsControls_sex_age_notion")
# 
# 
# 
# rld_mat <- assay(rld)
...
# 
# 
# png(file="pca_coding_k99cdr1notion.png", width = 2000, height = 1000, units = "px", pointsize = 12,
#     res = 100)
